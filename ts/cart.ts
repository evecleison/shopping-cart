...
function updateTotal(cart: CartItem[]) {
...
function renderCart() {
  ...
  if (cart.length === 0) {
    ...
    (document.querySelector(".cart-summary") as HTMLElement).style.display = "none";
    return;
  }
  ...
  (document.querySelector(".cart-summary") as HTMLElement).style.display = "block";
...
cartItemsContainer.addEventListener("click", (e) => {
  const target = e.target as HTMLElement; // Elemento que foi clicado
